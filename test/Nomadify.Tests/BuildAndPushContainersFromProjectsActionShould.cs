...
public class BuildAndPushContainersFromProjectsActionShould(NomadifyFixture fixture, ITestOutputHelper testOutputHelper) : IClassFixture<NomadifyFixture>
{
    [Fact]
    public async Task Execute()
    {
        ...
        var action = fixture.GetActionUnderTest<BuildAndPushContainersFromProjectsAction>(serviceProvider);
