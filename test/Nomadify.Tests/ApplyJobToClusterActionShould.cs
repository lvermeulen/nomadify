...
public class ApplyJobToClusterActionShould(NomadifyFixture fixture, ITestOutputHelper testOutputHelper) : IClassFixture<NomadifyFixture>
{
    [Fact]
    public async Task Execute()
    {
        ...
        var action = fixture.GetActionUnderTest<ApplyJobToClusterAction>(serviceProvider);
        ...
        await executionService.Received(2).ExecuteCommand(
